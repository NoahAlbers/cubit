...
export class BackupsComponent implements OnInit,OnDestroy {
 ...
 load(){this.http.get<any>('/api/backups').subscribe({next:d=>{this.data=d;if(!this.dirty){this.form={...d.settings};this.revision=d.revision;}},error:e=>this.error=e.error?.message||'Could not load backups.'});}
