...
export class WaiversComponent implements OnInit {
  ...
  constructor(public gate:WaiverPreviewService,private drafts:DraftGuard,private http:HttpClient, public navigation:ListNavigationService, private route:ActivatedRoute, private router:Router){}
