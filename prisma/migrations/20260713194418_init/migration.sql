...
-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('WELCOME', 'MAGIC_LINK', 'PAYMENT_RECEIPT', 'PAYMENT_FAILED', 'RENEWAL_REMINDER', 'PLAN_EXPIRING', 'KEY_DEACTIVATED', 'PASSWORD_RESET', 'WAIVER_REMINDER', 'ADMIN_NEW_SIGNUP', 'ADMIN_PAYMENT_FAILED', 'ADMIN_OVERDUE_DIGEST', 'ANNOUNCEMENT');
...
-- CreateIndex
CREATE UNIQUE INDEX "Member_magicLinkToken_key" ON "Member"("magicLinkToken");
...
-- CreateIndex
CREATE INDEX "MemberPlan_memberId_idx" ON "MemberPlan"("memberId");
...
-- AddForeignKey
ALTER TABLE "Key" ADD CONSTRAINT "Key_memberId_fkey" FOREIGN KEY ("memberId") REFERENCES "Member"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "MemberNote" ADD CONSTRAINT "MemberNote_authorId_fkey" FOREIGN KEY ("authorId") REFERENCES "Member"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "EquipmentCertification" ADD CONSTRAINT "EquipmentCertification_memberId_fkey" FOREIGN KEY ("memberId") REFERENCES "Member"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "MemberWaiver" ADD CONSTRAINT "MemberWaiver_memberId_fkey" FOREIGN KEY ("memberId") REFERENCES "Member"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "MemberWaiver" ADD CONSTRAINT "MemberWaiver_waiverId_fkey" FOREIGN KEY ("waiverId") REFERENCES "WaiverTemplate"("id") ON DELETE CASCADE ON UPDATE CASCADE;
